    ...
    <form method='post' action="/RS/arc/">
      ...
      <br>
        ...
        <div class="col">
          ...
          <input type="text" name="ent" value="<?php echo (isset($_POST["ent"]) && $_POST["ent"] != "" ? $_POST["ent"] : "");?>">
        </div>
       
       
        <div class="col">
          <label>postcode:</label>
          <input type="text" name="postcode" value="<?php echo (isset($_POST["postcode"]) && $_POST["postcode"] != "" ? $_POST["postcode"] : "");?>">
        </div>
     
        <div class="col">
          <label>RequestID:</label>
          <input type="text" name="id" value="<?php echo (isset($_POST["id"]) && $_POST["id"] != "" ? $_POST["id"] : "");?>">
        </div>
        ...
        <div class="col">
          ...
          <input type="date" name="collectdate" value="<?php echo (isset($_POST["collectdate"]) && $_POST["collectdate"] != "" ? $_POST["collectdate"] : "");?>">
        </div>
          <Br>
          <label>Area:</label>
  ...
  ?>        
    ...
    <br>
      <br>
        ...
        <a data-toggle="tooltip" class="tooltipLink" data-original-title="select checkbox of line you want to delete.">
          <span class="glyphicon glyphicon-info-sign"></span></a>
          </div>
          <br>
          <div id='undonesec'>
    ...
    <td>  
    <button id='rebtn'  class='btn btn-warning'>Rebate</button><br><br>
    <div id='rebarea'>
...
<input type="number" id="rebmess" class='rebatemes' placeholder= "Rebate Ammount"/><br>
    ...
    <input id="rebsub" type="submit"   value="Submit" class="btn btn-success rebsub" /> 
        ...
        <td>  
    <button id='invbtn'  class='btn btn-warning'>Invoice(DONT USE)</button><br><br>
    <div id='invarea'>
    <div class="input-group">
