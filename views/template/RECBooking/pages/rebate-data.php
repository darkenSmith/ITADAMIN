...
<table id='company' width='100%' class='sortable table table-hover'>
    ...
    foreach ($rebateData as $row) {
        ...
        echo " 
        <tr class='trstuff'>
        <td id='btnns'><button type='submit'  style='visibility:hidden;'  id='sav'  class='btn btn-success'> Save </button><button type='submit' id='edi' class='btn btn-secondary'> Edit </button></td>
